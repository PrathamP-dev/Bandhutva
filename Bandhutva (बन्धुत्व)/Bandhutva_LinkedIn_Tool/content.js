...
// Function to add the control buttons and select all
...
// Function to add individual checkboxes
function addCheckboxes() {
    ...
    invitations.forEach(invite => {
        ...
        const header = invite.querySelector(".artdeco-entity-lockup__title, .discover-person-card__name");
        if (header) {
...
// Function to handle Accept/Reject for selected checkboxes
...
// MutationObserver to watch for new content
...
// Add animations and button styles
